...
import { peopleFilterSchema } from '../schemas/people-filter.schema';
...
export default function PeopleSidebar({ children }: PeopleSidebarProps) {
    const form = useForm<z.infer<typeof peopleFilterSchema>>({
    ...
    function onSubmit(values: z.infer<typeof peopleFilterSchema>) {
