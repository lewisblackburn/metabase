...
function Button({ className, variant, size, render, ...props }: ButtonProps) {
    ...
    // Filter out asChild if it exists to prevent DOM warnings
    const { asChild, ...filteredProps } = props as ButtonProps & { asChild?: boolean }

    return useRender({
        defaultTagName: 'button',
        props: mergeProps<'button'>(defaultProps, filteredProps),
        render,
    })
}
