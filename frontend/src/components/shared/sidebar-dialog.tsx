    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            <DialogContentNoClose
                className={cn('overflow-hidden p-0 md:max-h-[800px] md:max-w-[900px] lg:max-w-[1200px]', className)}>
                <SidebarProvider>
                    ...
                    <div className='w-full'>
                        ...
                        <main className='max-h-[800px] overflow-y-auto p-5 pb-48'>{content}</main>
                    </div>
                </SidebarProvider>
            </DialogContentNoClose>
        </Dialog>
